...
public class AirplaneTestApp {
    ...
    private void showTestEntryScreen() {
        ...
        // "faa_test" table.
        populateDropdown(testDropdown, "SELECT test_number FROM airport.faa_test");
        // END-STUDENT-CODE
    ...
    private void submitTestRecord() {
        ...
        try {
            ...
            // table.
            String sql = "INSERT INTO airport.test_event (test_number, ssn, reg_number, date, duration, score) VALUES (?, ?, ?, CURRENT_DATE, MAKE_INTERVAL(hours := ?, mins := ?, secs := ?), ?)";
            // END-STUDENT-CODE
